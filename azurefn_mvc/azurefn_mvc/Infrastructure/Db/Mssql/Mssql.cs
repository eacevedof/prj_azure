...
namespace azurefn_mvc.Infrastructure.Db.Mssql
{
    public sealed class Mssql
    {
        ...
        {
            _stringConnection = DbConnectionString.GetInstanceByContextDto(contextDto).GetStringOrFail();
            _connection = new SqlConnection(_stringConnection);
        }

        public Mssql(string stringConnection)
        {
        ...
        public static Mssql GetInstanceByStringConnection(string stringConnection)
        {
            return new Mssql(stringConnection);
        }
